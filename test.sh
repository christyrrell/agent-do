...
check_cmd "media family tests" python3 "$SCRIPT_DIR/tests/test_media.py"
check_cmd "media provider handbrake tests" python3 "$SCRIPT_DIR/tests/test_handbrake.py"
check_cmd "substack tests" python3 "$SCRIPT_DIR/tests/test_substack.py"
check_cmd "media provider makemkv tests" python3 "$SCRIPT_DIR/tests/test_makemkv.py"
